      ...
      <div className="generic-wrapper">
        ...
        <div className="delete-account-button">
          <div className="delete-account-button__text">
            ...
            {this.props.user && auth.currentUser && !this.props.user.securityPassword && this.props.user && auth.currentUser.providerData[0].providerId === "google.com" &&
              <h3>In order to delete your account you must create your security password</h3>          
            }
          </div>
          <button
            disabled={!this.props.user || (auth.currentUser && this.props.user && auth.currentUser.providerData[0].providerId === "google.com" && !this.props.user.securityPassword)}
